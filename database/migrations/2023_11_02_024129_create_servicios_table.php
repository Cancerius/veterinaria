...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        DB::statement('ALTER TABLE servicios ADD CONSTRAINT chk_tipo_servicio CHECK (tipo_servicio REGEXP "^[A-Za-zÁÉÍÓÚáéíóúÜüÑñ ]+$")');
        DB::statement('ALTER TABLE servicios ADD CONSTRAINT chk_costo CHECK (LENGTH(costo) >= 2 AND LENGTH(costo) <= 3 AND costo REGEXP "^[0-9]+$")');
    }
