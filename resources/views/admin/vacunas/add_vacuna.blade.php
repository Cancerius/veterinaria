                    ...
                    <div class="col-lg-8 offset-lg-2">
                        <form method="POST" action="{{ route('vacuna.store') }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for='vacuna'>Vacuna<span class="text-danger">*</span></label>
                                        <input class="form-control" type="text" id="vacuna" name="vacuna">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="peso" id="edad" name="peso">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
