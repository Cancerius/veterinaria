    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            <div class="content">
                ...
                @endif
                        <form method="POST" action="{{ route('admin.registros.consulta.update', ['id' => $consulta->id]) }}">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" type="text" id="id_propietario" name="id_propietario" >
                                            ...
                                            <option value="{{ $propietario->id }}" {{ $propietario->id === $consulta->id_propietario ? 'selected' : '' }}>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" type="text" id="id_mascota" name="id_mascota" >
                                            ...
                                            <option value="{{ $mascota->id }}" {{ $mascota->id === $consulta->id_mascota ? 'selected' : '' }}>
                                        ...
                                        <select class="form-control" type="text" id="id_veterinario" name="id_veterinario" >
                                            @foreach ($veterinarios as $user)
                                                @if ($user->id === Auth::id()) <!-- Filtrar el usuario autenticado -->
                                                    <option value="{{ $user->id }}" {{ $user->id === $consulta->id_veterinario ? 'selected' : '' }}>
                                ...
                                <div class="col-sm-6 ">
                                    <div class="form-group ">
                                        ...
                                        <div class="cal-icon">
                                            <input type="date" class="form-control" id="fecha_consulta" name="fecha_consulta" value="{{ $consulta->fecha_consulta }}" readonly>
                                        </div>
                                    </div>
                                </div>
                                <script>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date">
                                            <input type="date" class="form-control" id="fecha_cita" name="fecha_cita" value="{{ $consulta->fecha_cita }}">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control center" type="text" id="temperatura" name="temperatura" value="{{ $consulta->temperatura }}">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for='peso'>Peso <span class="text-danger">*</span></label>
                                        <input class="form-control" type="text" id="peso" name="peso" value="{{ $consulta->peso }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" id="fre_cardiaca" name="fre_cardiaca" value="{{ $consulta->fre_cardiaca }}">
                                    </div>
                                </div> 
                                ...
                                <div class="col-sm-6 ">
                                    <div class="form-group ">
                                        ...
                                        <input class="form-control" type="text" id="fre_respiratoria" name="fre_respiratoria" value="{{ $consulta->fre_respiratoria }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <textarea cols="40" rows="3" class="form-control" type="text" id="dolores_localizados" name="dolores_localizados">{{ $consulta->dolores_localizados }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <textarea cols="40" rows="3" class="form-control" id="diagnostico" name="diagnostico">{{ $consulta->diagnostico }}</textarea>
