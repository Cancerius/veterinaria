            ...
            <div class="content">
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <h4 class="page-title">Agregar Mascota</h4>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <form method="POST" action="{{ route('mascotas.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control center" type="text" id="raza" name="raza">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="profile-upload">
                                    <div class="form-group">
                                        ...
                                        <div class="profile-upload">
                                            <img id="vista_previa_imagen"  style="max-width: 100%; max-height: 200px;">
                                        </div>
                                    </div>
                        ...
                        <div class="m-t-20 text-center">
                            <button class="btn btn-primary submit-btn center">Añadir mascota</button>
                        </div>
