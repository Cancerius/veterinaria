...
<body>
            ...
            <div class="content">
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <h4 class="page-title">Editar Mascota</h4>
                    </div>
                </div>
                ...
                @endif
                        <form method="POST" action="{{ route('admin.registros.mascotas.update', ['id' => $mascota->id]) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" type="text" id="id_propietario" name="id_propietario" >
                                            ...
                                            <option value="{{ $propietario->id }}" {{ $propietario->id === $mascota->id_propietario ? 'selected' : '' }}>
                                        ...
                                        <select class="form-control" type="text" id="id_veterinario" name="id_veterinario" >
                                            @foreach ($veterinarios as $user)
                                                @if ($user->id === Auth::id()) <!-- Filtrar el usuario autenticado -->
                                                    <option value="{{ $user->id }}" {{ $user->id === $mascota->id_veterinario ? 'selected' : '' }}>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" id="nombre_mascota" name="nombre_mascota" value="{{ $mascota->nombre_mascota }}">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for='raza'>Raza <span class="text-danger">*</span></label>
                                        <input class="form-control center" type="text" id="raza" name="raza" value="{{ $mascota->raza }}">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for='sexo'>Sexo <span class="text-danger">*</span></label>
                                        <input class="form-control" type="text" id="sexo" name="sexo" value="{{ $mascota->sexo }}">
                                    </div>
                                </div> 
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" id="peso" name="peso" value="{{ $mascota->peso }}">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for='color'>Color <span class="text-danger">*</span></label>
                                        <input class="form-control" type="text" id="color" name="color" value="{{ $mascota->color }}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <img id="imagen_previa" style="max-width: 100%; max-height: 200px;" class="img-fluid">
                                </div>
                            </div>
                            
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label>Seleccionar Nueva Imagen <span class="text-danger">*</span></label>
                                    <div class="profile-upload">
                                        <div class="upload-input" style="position: relative;">
                                            <!-- Input de archivo oculto -->
                                            <input type="file" class="form-control" id="imagen" name="imagen" onchange="mostrarNombreArchivo()" style="opacity: 0; position: absolute; top: 0; left: 0; width: 100%; height: 100%; cursor: pointer;">
                                            
                                            <!-- Campo visible que muestra el nombre del archivo -->
                                            <input type="text" id="nombreArchivo" class="form-control" readonly style="pointer-events: none;" value="{{ $mascota->imagen }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        function mostrarNombreArchivo() {
            ...
            var nombreArchivo = input.files[0] ? input.files[0].name : '{{ $mascota->imagen }}';
...
<script src="{{asset('assetsadmin/js/bootstrap-datepicker.es.min.js')}}"></script> <!-- Asegúrate de actualizar la ruta -->
