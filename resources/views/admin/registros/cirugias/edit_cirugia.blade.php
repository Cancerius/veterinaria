            ...
            <div class="content">
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <h4 class="page-title">Editar Cirugia</h4>
                    </div>
                </div>
                ...
                @endif
                        <form method="POST" action="{{ route('admin.registros.cirugia.update', ['id' => $cirugia->id]) }}">
                            @csrf
                            @method ('PUT')
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" type="text" id="id_propietario" name="id_propietario" >
                                            @foreach ($propietarios as $propietario)
                                            <option value="{{ $propietario->id }}" {{ $propietario->id === $cirugia->id_propietario ? 'selected' : '' }}>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" type="text" id="id_mascota" name="id_mascota" >
                                            @foreach ($mascotas as $mascota)
                                            <option value="{{ $mascota->id }}" {{ $mascota->id === $cirugia->id_mascota ? 'selected' : '' }}>
                                        ...
                                        <select class="form-control" type="text" id="id_veterinario" name="id_veterinario" >
                                            @foreach ($veterinarios as $user)
                                                @if ($user->id === Auth::id()) <!-- Filtrar el usuario autenticado -->
                                                    <option value="{{ $user->id }}" {{ $user->id === $cirugia->id_veterinario ? 'selected' : '' }}>
                                ...
                                <div class="col-sm-6 ">
                                    <div class="form-group ">
                                        <label for='fecha_cirugia'>Fecha Cirugia</label>
                                        <div class="cal-icon">
                                            <input type="date" class="form-control" id="fecha_cirugia" name="fecha_cirugia" value="{{ $cirugia->fecha_cirugia }}" readonly>
                                        </div>
                                    </div>
                                </div>
                                <script>
                                    // Obtén la referencia al campo de entrada de fecha
                                    var fechaConsultaInput = document.getElementById('fecha_cirugia');
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date">
                                            <input type="date" class="form-control" id="fecha_cita" name="fecha_cita" value="{{ $cirugia->fecha_cita }}">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control center" type="text" id="temperatura" name="temperatura" value="{{ $cirugia->temperatura }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for='fre_cardiaca'>Frecuencia Cardiaca <span class="text-danger">*</span></label>
                                        <input class="form-control" type="text" id="fre_cardiaca" name="fre_cardiaca" value="{{ $cirugia->fre_cardiaca }}">
                                    </div>
                                </div> 
                                
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for='fre_respiratoria'>Frecuencia Respiratoria <span class="text-danger">*</span></label>
                                        <input class="form-control" type="text" id="fre_respiratoria" name="fre_respiratoria" value="{{ $cirugia->fre_respiratoria }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" id="peso" name="peso" value="{{ $cirugia->peso }}">
                                    </div>
                                </div>

                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for='tipo_cirugia'>tipo de cirugia <span class="text-danger">*</span></label>
                                        <input class="form-control" type="text" id="tipo_cirugia" name="tipo_cirugia" value="{{ $cirugia->tipo_cirugia }}">
                                    </div>
                                </div>   
