            ...
            <div class="content">
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <h4 class="page-title">Nueva Cirugia</h4>
                    </div>
                </div>
                ...
                @endif
                        <form method="POST" action="{{ route('cirugias.store') }}">
                            @csrf
                            <div class="row">
                                <div class="col-sm-6">
                                ...
                                <div class="col-sm-6 ">
                                    <div class="form-group ">
                                        ...
                                        <div class="cal-icon">
                                            <input type="date" class="form-control" id="fecha_cirugia" name="fecha_cirugia" readonly>
                                        </div>
                                    </div>
                                </div>
                                <script>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" id="tipo_cirugia" name="tipo_cirugia">
                            ...
                            <div class="m-t-20 text-center">
                                <button class="btn btn-primary submit-btn center">Agregar Cirugia</button>
                            </div>
                        </form>
                    </div>
                </div>
