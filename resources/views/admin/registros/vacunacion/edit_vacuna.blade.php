            ...
            <div class="content">
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <h4 class="page-title">Editar Vacunacion</h4>
                    </div>
                </div>
                ...
                @endif
                        <form method="POST" action="{{ route('admin.registros.vacuna.update', ['id' => $vacunacion->id]) }}">
                            @csrf
                            @method ('PUT')
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" type="text" id="id_mascota" name="id_mascota" >
                                            ...
                                            <option value="{{ $mascota->id }}" {{ $mascota->id === $vacunacion->id_mascota ? 'selected' : '' }}>
                                        ...
                                        <select class="form-control" type="text" id="id_veterinario" name="id_veterinario" >
                                            @foreach ($veterinarios as $user)
                                                @if ($user->id === Auth::id()) <!-- Filtrar el usuario autenticado -->
                                                    <option value="{{ $user->id }}" {{ $user->id === $vacunacion->id_veterinario ? 'selected' : '' }}>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" type="text" id="id_propietario" name="id_propietario" >
                                            ...
                                            <option value="{{ $propietario->id }}" {{ $propietario->id === $vacunacion->id_propietario ? 'selected' : '' }}>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for='id_producto'>Nombre Producto <span class="text-danger">*</span></label>
                                        <select class="form-control" type="text" id="id_producto" name="id_producto" >
                                            @foreach ($productos as $producto)
                                            <option value="{{ $producto->id }}" {{ $producto->id === $vacunacion->id_producto ? 'selected' : '' }}>
                                ...
                                <div class="col-sm-6 ">
                                    <div class="form-group ">
                                        ...
                                        <div class="cal-icon">
                                            <input type="date" class="form-control" id="fecha" name="fecha" value="{{$vacunacion->fecha}}" readonly>
                                        </div>
                                    </div>
                                </div>
                                <script>
                                    // Obtén la referencia al campo de entrada de fecha
                                    var fechaConsultaInput = document.getElementById('fecha');
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date">
                                            <input type="date" class="form-control" id="fecha_cita" name="fecha_cita" value="{{ $vacunacion->fecha_cita }}">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control center" type="text" id="costo" name="costo" value="{{$vacunacion->costo}}">
                                    </div>
                                </div>   
