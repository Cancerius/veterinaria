            ...
            <div class="content">
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <h4 class="page-title">Agregar Vacunacion</h4>
                    </div>
                </div>
                ...
                @endif
                        <form method="POST" action="{{ route('vacunas.store') }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" type="text" id="id_producto" name="id_producto" >
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control center" type="text" id="costo" name="costo">
                            ...
                            <div class="m-t-20 text-center">
                                <button class="btn btn-primary submit-btn center">Añadir Vacunacion</button>
                            </div>
                        </form>
                    </div>
                </div>
