                    ...
                    <div class="col-lg-8 offset-lg-2">
                        @if ($errors->any())
                            ...
                            <form method="POST" action="{{ route('admin.roles.update', $role) }}">
                                ...
                                <h4 class="page-title text-center">Lista de permisos</h4>
                                     ...
                                     @endphp
                                        @foreach ($permissions as $permission)
                                            <tr class="table-success">
                                                ...
                                                <td>
                                                    <label>
                                                        {!! Form::checkbox('permissions[]', $permission->id, $role->permissions->contains($permission->id), ['class'=>'mr-1']) !!}
                                                    </label>
                                                </td>
                                            </tr>
                                            @php
                                ...
                                <div class="m-t-20 text-center">
                                    <button type="submit" class="btn btn-primary submit-btn center">Actualizar Rol</button>
                                </div>
                            </form>
                    </div>
                </div>
