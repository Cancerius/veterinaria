            ...
            <div class="content">
                <div class="row">
                    <div class="col-sm-4 col-3">
                        <h4 class="page-title">Consultas Realizadas</h4>
                    </div>
                    <div class="col-sm-8 col-9 text-right m-b-20">
                        <a href="{{route('admin.consultas.add_consulta')}}" class="btn btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Nueva Consulta</a>
                    </div>
                </div>
						...
						<div class="table-responsive">
							<table class="table table-bordered table-striped custom-table mb-1">
								<thead>
									<tr>
                                        <th>ID</th>
										<th class="col-6">Medico</th>
										<th class="col-md-12">Nombre de la mascota</th>
										<th>Tos</th>
                                        <th>Decaimiento</th>
										<th>Apetito</th>
                                        <th>Vomito</th>
