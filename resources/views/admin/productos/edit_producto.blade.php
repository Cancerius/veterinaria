    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            <div class="content">
                ...
                @endif
                        <form method="POST" action="{{ route('admin.registros.producto.update', ['id' => $producto->id]) }}">
                            @csrf
                            @method ('PUT')
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control center" type="text" id="nombre_producto" name="nombre_producto" value="{{ $producto->nombre_producto}}">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 ">
                                    <div class="col-sm-13">
                                        <div class="form-group">
                                            <label>Fecha de Vencimiento <span class="text-danger">*</label>
                                            <div class="input-group date">
                                                <input type="date" class="form-control" id="fecha_exp" name="fecha_exp" value="{{$producto->fecha_exp}}">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <textarea cols="100" rows="3" class="form-control" type="text" id="descripcion" name="descripcion">{{ $producto->descripcion}}</textarea>
                                    </div>
                                </div>
