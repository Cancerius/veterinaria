            ...
            <div class="content">
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <h4 class="page-title">Nueva Producto</h4>
                    </div>
                </div>
                ...
                @endif
                        <form method="POST" action="{{ route('productos.store') }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control center" type="text" id="nombre_producto" name="nombre_producto">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <textarea cols="100" rows="3" class="form-control" type="text" id="descripcion" name="descripcion"></textarea>
                            ...
                            <div class="m-t-20 text-center">
                                <button class="btn btn-primary submit-btn center">Agregar Producto</button>
                            </div>
                        </form>
                    </div>
                </div>
