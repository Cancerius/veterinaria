    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            <div class="content">
                ...
                @endif
                        <form method="POST" action="{{ route('admin.registros.servicio.update', ['id' => $servicio->id]) }}">
                            @csrf
                            @method ('PUT')
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" type="text" id="id_propietario" name="id_propietario" >
                                            ...
                                            <option value="{{ $propietario->id }}" {{ $propietario->id === $servicio->id_propietario ? 'selected' : '' }}>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for='id_mascota'>Nombre de la Mascota <span class="text-danger">*</span></label>
                                        <select class="form-control" type="text" id="id_mascota" name="id_mascota" >
                                            @foreach ($mascotas as $mascota)
                                            <option value="{{ $mascota->id }}" {{ $mascota->id === $servicio->id_mascota ? 'selected' : '' }}>
                                        ...
                                        <select class="form-control" type="text" id="id_veterinario" name="id_veterinario" >
                                            @foreach ($veterinarios as $user)
                                                @if ($user->id === Auth::id()) <!-- Filtrar el usuario autenticado -->
                                                    <option value="{{ $user->id }}" {{ $user->id === $servicio->id_veterinario ? 'selected' : '' }}>
                                ...
                                <div class="col-sm-6 ">
                                    <div class="form-group ">
                                        ...
                                        <div class="cal-icon">
                                            <input type="date" class="form-control" id="fecha_servicio" name="fecha_servicio" value="{{ $servicio->fecha_servicio}}" readonly>
                                        </div>
                                    </div>
                                </div>
                                <script>
                                    // Obtén la referencia al campo de entrada de fecha
                                    var fechaConsultaInput = document.getElementById('fecha_servicio');
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for='tipo_servicio'>Tipo del Servicio <span class="text-danger">*</span></label>
                                        <input class="form-control" type="text" id="tipo_servicio" name="tipo_servicio" value="{{ $servicio->tipo_servicio}}">
                                    </div>
                                </div> 
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" id="costo" name="costo" value="{{ $servicio->costo}}">
                                    </div>
                                </div>
