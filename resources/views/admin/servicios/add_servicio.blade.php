                ...
                @endif
                        <form method="POST" action="{{ route('servicios.store') }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 ">
                                    <div class="form-group ">
                                        ...
                                        <div class="cal-icon">
                                            <input type="date" class="form-control" id="fecha_servicio" name="fecha_servicio" readonly>
                                        </div>
                                    </div>
                                </div>
                                <script>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" id="tipo_servicio" name="tipo_servicio" >
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for='costo'>Costo (Bs)<span class="text-danger">*</span></label>
                            ...
                            <div class="m-t-20 text-center">
                                <button class="btn btn-primary submit-btn center">Añadir Servicio</button>
                            </div>
                        </form>
                    </div>
                </div>
