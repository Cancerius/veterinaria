            ...
            <div class="content">
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <h4 class="page-title">Actualizar veterinario</h4>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        @if ($errors->any())
                            ...
                            @endif
                            <form method="POST" action="{{ route('admin.doctor.update', $user) }}" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input placeholder="Nombre veterinario" class="form-control" type="text" id="nombre_completo" name="nombre_completo" value="{{ $user->nombre_completo }}" />
                                        </div>
                                ...
                                <div class="m-t-20 text-center">
                                    <button type="submit" class="btn btn-primary submit-btn center formulario-editar">Actualizar Veterinario</button>
                                </div>
                            </form>
                    </div>
                </div>
