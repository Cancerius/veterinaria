            ...
            <div class="content">
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <h4 class="page-title">Agregar veterinario</h4>
                    </div>
                </div>
                    ...
                    <div class="col-lg-8 offset-lg-2">
                        ...
                        <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="nombre_completo">Nombre Veterinario <span class="text-danger">*</span></label>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input class="form-control center" type="password" id="password" name="password" />
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="password_confirmation">Repita la contraseña <span class="text-danger">*</span></label>
                                        <div class="input-group">
                                            <input class="form-control center" type="password" id="password_confirmation" name="password_confirmation" />
                                            <div class="input-group-append">
                                                <button class="btn btn-outline-secondary" type="button" onclick="togglePassword('password_confirmation')">
                                                    <i id="password-confirmation-toggle-icon" class="fa-solid fa-eye"></i>
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="m-t-20 text-center">
                                <button class="btn btn-primary submit-btn center">Crear Veterinario</button>
                            </div>
                        </form>
                    </div>
                </div>
