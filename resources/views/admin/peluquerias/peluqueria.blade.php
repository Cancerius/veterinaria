            ...
            <div class="content">
                <div class="row">
                    <div class="col-sm-4 col-3">
                        <h4 class="page-title">Peluqueria</h4>
                    </div>
                    <div class="col-sm-8 col-9 text-right m-b-20">
                        <a href="{{route('admin.peluquerias.add_peluqueria')}}" class="btn btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i>Registrar</a>
                    </div>
                </div>
						...
						<div class="table-responsive">
							<table class="table table-bordered table-striped custom-table mb-1">
								...
								<tbody>
									...
									<tr>
                                        <td>{{ $peluqueria->id }}</td>
                                        <td>{{ $peluqueria->medico->name }}</td>
										<td>{{ $peluqueria->fecha }}</td>
										<td>{{ $peluqueria->nombre_propietario }}</td>
										<td>{{ $peluqueria->nombre_mascota }}</td>
										<td>{{ $peluqueria->peluqueria }}</td>
										<td>{{ $peluqueria->edad }}</td>
                                        <td>{{ $peluqueria->peso }}</td>
                                        <td>{{ $peluqueria->celular }}</td>
										<td class="text-right">
