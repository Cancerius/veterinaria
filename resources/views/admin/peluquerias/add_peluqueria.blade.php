    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            <div class="content">
                ...
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <form method="POST" action="{{ route('peluqueria.store') }}">
                            @csrf
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for='id_medico'>Nombre Medico <span class="text-danger"></span></label>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for='peluqueria'>Peluqueria y baño<span class="text-danger">*</span></label>
                                        <input class="form-control" type="text" id="peluqueria" name="peluqueria">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="peso" id="peso" name="peso">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
